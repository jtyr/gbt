...
func TestRun(t *testing.T) {
	tests := []struct {
		...
		{cmd: []string{"curl", "-s", "-S", "http://localhost:12345"}, trim: true, rc: 7, stdout: "", stderr: "curl: (7) Failed to connect to localhost port 12345 after 0 ms: Couldn't connect to server"},
