...
export GBT_CAR_GIT_STATUS_MODIFIED_FORMAT='{{ StatusModifiedSymbol }}{{ StatusModifiedCount }}'
...
export GBT_CAR_GIT_STATUS_DELETED_FORMAT='{{ StatusDeletedSymbol }}{{ StatusDeletedCount }}'
...
export GBT_CAR_GIT_STATUS_UNTRACKED_FORMAT='{{ StatusUntrackedSymbol }}{{ StatusUntrackedCount }}'
...
export GBT_CAR_GIT_STATUS_STAGED_FORMAT='{{ StatusStagedSymbol }}{{ StatusStagedCount }}'
